...
public class MainMenu : MonoBehaviour
{
    ...
    void BuildMainPanel(Transform parent)
    {
        ...
        // Buttons
        CreateButton(mainPanel.transform, "Play", new Vector2(0, -40),
            () => GameManager.Instance.LoadScene(GameManager.Instance.firstLevelScene));
        CreateButton(mainPanel.transform, "Settings", new Vector2(0, -110), ShowSettings);
        CreateButton(mainPanel.transform, "Quit", new Vector2(0, -180),
